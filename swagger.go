...
func DefaultModelsExpandDepth(depth int) func(*Config) { _ = "STUB: not implemented"; return nil }
...
func Oauth2UsePkce(usePkce bool) func(*Config) { _ = "STUB: not implemented"; return nil }
